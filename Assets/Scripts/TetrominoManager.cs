...
public class TetrominoManager : MonoBehaviour {
    ...
    Tetromino I_Block = new Tetromino(new Vector2(0, -1), new Vector2(0, 1), new Vector2(0, 2));
    ...
    Tetromino Square = new Tetromino(new Vector2(0, 1), new Vector2(1, 1), new Vector2(1, 0));
    Tetromino T_Block = new Tetromino(new Vector2(-1, 0), new Vector2(1, 0), new Vector2(0, -1));
